...
class ConnectedUseCase:
    ...
    async def check_if_connected(self, handle_one: str, handle_two: str, errors: List[str] = None) -> Optional[ConnectedOut]:
        orgs = await self.get_common_organizations(handle_one, handle_two, errors=errors)
        following = await self.are_devs_following_each_other(handle_one, handle_two, errors=errors)
        if errors:
            return False
    ...
    async def get_common_organizations(self, handle_one: str, handle_two: str, errors: list = None):
    ...
    async def are_devs_following_each_other(self, handle_one: str, handle_two: str, errors: list = None):
    ...
    async def register_connection(self, connected: ConnectedOut, handle_first: str, handle_second: str) -> ConnectedOut:
    ...
    async def get_registers(self, handle_first: str, handle_second: str) -> List[ConnectedOut]:
        return await self.__repo_adapter.get_registers(self.__db, handle_first, handle_second)
